...
## The first R function "makeCacheMatrix" uses the R function "solve" (instead of "mean").  The place where the result of solve (applied to some defined argument) will be stored is called "hueco", which in spanish means "hole". 
...
## In the next instrucction ma is set as a variable whose definition will be assigned by a search through the parent environemnt from wich it is called.
